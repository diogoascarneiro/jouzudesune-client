        ...
        <div className="flex flex-col w-full lg:w-2/6">
          ...
          <div className="card h-full bg-primary rounded-box py-5 px-10 text-center justify-between">
            ...
            <div className="stack bg-neutral mx-12 lg:mx-28 py-6 rounded-xl mb-5 lg:mb-3">
              <div
                className="grid w-32 h-40 rounded text-primary-content place-content-center"
                style={{
          ...
          <div className="flex flex-wrap lg:flex-nowrap gap-x-10 gap-y-5 text-center lg:h-full">
            <div className="w-full lg:w-2/4 py-5 px-10 card bg-primary rounded-box justify-between lg:h-full">
              <div>
                ...
                <p className="lg:px-10">Feeling adventurous? Choose a number of cards and we'll fetch you a completely random deck. Let's see how you do!</p>
              </div>
              <div>
            ...
            <div className="w-full lg:w-2/4 py-5 px-10 lg:h-full card bg-primary rounded-box justify-between mb-10">
              ...
              <p className="mb-5 lg:mb-2">Need a refresher? We'll make a deck out of the cards you've already seen to help you memorize them.</p>
              <div className="form-control bg-neutral rounded-xl mb-5 lg:m-0 p-3">
                <label className="label cursor-pointer">
                  <span className="label-text">
                    <b>Lower scored cards first</b>
                  </span>
                  <input type="radio" name="radio-6" className="radio radio-primary checked:bg-primary" onChange={() => setSeenDeckType("seenLowFirst")} />
                </label>
                <label className="label cursor-pointer">
                  <span className="label-text">
                    <b>Random</b>
                  </span>
                  <input type="radio" name="radio-6" className="radio radio-primary checked:bg-primary" onChange={() => setSeenDeckType("seenRandom")} />
                </label>
              </div>
              <div>
                ...
                {!seenDeckType && (
                  <button className="btn btn-secondary btn-disabled btn-wide" aria-disabled="true">
                    Start
                  </button>
                )}
              </div>
