...
let meaningCapitalized = card.wordMeanings.charAt(0).toUpperCase() + card.wordMeanings.slice(1);
  ...
  return (<CardTransition>
    ...
    <div className="card bg-neutral shadow-xl px-3 py-8 lg:p-8 mb-10">
      <div className="flex items-center justify-evenly lg:flex-col lg:px-20">
          <ruby>
      ...
      <div className="card-body pb-0">
        <div>
          ...
          <AudioButton src={`/media/${card.exampleAudio}`} className="justify-self-end self-center mt-1">Listen</AudioButton></div>
        </div>
